...
non.marine <- c("Arachnida", "Insecta", "Collembola", "Palaeophreatoicidae",
                ...
                "Baringaspis", "Boreania", "Boreaspis", "Brachipteraspis", 
                "Brachyacanthus", "Bryantolepis", "Canonia", "Cardipeltis", 
                "Cephalaspis", "Cheirolepis", "Ciderius", "Climatius", 
                "Cosmaspis", "Ctenaspis", "Davelaspis", "Dinaspidella", 
                "Dobraspis", "Dobunnacanthus", "Doryaspis", "Ectinaspis", 
                "Elpistostege", "Escharaspis", "Escuminaspis", "Euphanerops", 
                "Euproprotapsis", "Eusthenopteron", "Euthacanthus", 
                "Fleurantia", "Gigantaspis", "Gomphonchus", "Gustavaspis", 
                "Gyracanthus", "Heightingtonaspis", "Hildenaspis", "Hoelaspis", 
                "Holoptychius", "Homalacanthus", "Homalaspidella", 
                "Ilemoraspis", "Kiaeraspis", "Lampraspis", "Lanarkia", 
                "Larnovaspis", "Lasanius", "Lepidaspis", "Levesquaspis", 
                "Machairaspis", "Mesacanthus", "Miguashaia", "Miltaspis", 
                "Mimetaspis", "Nectaspis", "Nikolivia", "Nodonchus", 
                "Norselaspis", "Onchus", "Parameteoraspis", "Parexus", 
                "Pattenaspis", "Phialaspis", "Plectrodus", "Plourdosteus", 
                "Podolaspis", "Protaspis", "Protodus", "Pterolepis", 
                "Quebecius", "Scaumenacia", "Scolenaspis", "Securiaspis", 
...
marine.exceptions <- c("Chelonioidea", "Ophidiomorpha", "Mosasauroidea", 
                       ...
                       "Balticaspis", "Benneviaspis", "Birkenia", "Bothriolepis",
                       "Brochoadmones", "Bryantonchus", "Cacheacanthus", 
                       "Camptaspis", "Canadapteraspis", "Cassidiceps", 
                       "Cheiracanthus", "Cometicercus", "Corvaspis", 
                       "Dartmuthia", "Dentapelta", "Diademaspis", "Didymaspis", 
                       "Diplacanthus", "Drepanolepis", "Ectopacanthus", 
                       "Elegestolepis", "Emerikodus", "Errivaspis", "Furcacauda", 
                       "Glabrapelta", "Gladiobranchus", "Gomphodus", 
                       "Hapilaspis", "Haplacanthus", "Helenolepis", 
                       "Hemicyclaspis", "Hirella", "Holonema", "Homostius", 
                       "Irregulareaspis", "Ischnacanthus", "Kalanaspis", 
                       ...
                       "Phoebodus", "Plataspis", "Poraspis", "Porolepis", 
                       "Procephalaspis", "Protacrodus", "Protopteraspis", 
                       "Pruemolepis", "Psammolepis", "Psammosteus", "Pteraspis",
                       "Ptychodictyon", "Pycnosteus", "Rhadinacanthus", 
                       "Rhinopteraspis", "Rhyncholepis", "Romundina", 
                       "Saaremaaspis", "Saarolepis", "Schizosteus", 
                       "Sclerodus", "Severaspis", "Shielia", "Simblaspis", 
                       "Skamolepis", "Sphenonectris", "Stegobranchiaspis", 
                       "Superciliaspis", "Tannuaspis", "Tartuosteus", 
                       "Tauraspis", "Thyestes", "Tremataspis", "Unarkaspis", 
                       "Watsonacanthus", "Witaaspis")
